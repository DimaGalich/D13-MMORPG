...
def respond_send_email(respond_id):
    ...
    send_mail(
        subject=f'WoW LFG: новый отклик на объявление!',
        ...
        from_email='roguesinister@mail.ru',
...
def respond_accept_send_email(response_id):
    ...
    send_mail(
        subject=f'WoW LFG: Ваш отклик принят!',
...
def send_mail_monday_8am():
    ...
    if list_week_posts:
        for user in User.objects.filter():
            ...
            send_mail(
                subject=f'WoW LFG: посты за прошедшую неделю.',
